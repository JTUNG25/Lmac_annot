...
# Mutant gene lists
# Generated by extract_gene_lists.R — mirrors plot_consensus_scatter() /
# plot_sample() scatter filters exactly (no score / effect-size cutoffs beyond
# what annotate_relationships() already applies).
#
# Consensus groups  : Δago1, Δago13, Δrdrp2, Δdcl2
# Single mutants    : Δago3, Δdcl1, Δrdrp1
#
# NOTE: Δdcl2 produced no Silencing pairs under strict consensus (all 4
#       consensus pairs were Derepression).
#       Δrdrp12 produced no Silencing or Derepression pairs under strict
#       consensus (all 4 were Basal Silencing) — no gene lists generated.
MUTANTS = {
    # ── AGO mutants ──────────────────────────────────────────────────────────
    "ago1_silencing":    "data/gene_lists/ago1_silencing.txt",
    "ago1_derepression": "data/gene_lists/ago1_derepression.txt",

    "ago13_silencing":    "data/gene_lists/ago13_silencing.txt",
    "ago13_derepression": "data/gene_lists/ago13_derepression.txt",

    "ago3_silencing":    "data/gene_lists/ago3_silencing.txt",
    "ago3_derepression": "data/gene_lists/ago3_derepression.txt",

    # ── DCL mutants ──────────────────────────────────────────────────────────
    "dcl1_silencing":    "data/gene_lists/dcl1_silencing.txt",
    "dcl1_derepression": "data/gene_lists/dcl1_derepression.txt",

    "dcl2_derepression": "data/gene_lists/dcl2_derepression.txt",
    # dcl2_silencing: not generated — no Silencing pairs in strict consensus

    # ── RDRP mutants ─────────────────────────────────────────────────────────
    "rdrp1_silencing":    "data/gene_lists/rdrp1_silencing.txt",
    "rdrp1_derepression": "data/gene_lists/rdrp1_derepression.txt",

    "rdrp2_silencing":    "data/gene_lists/rdrp2_silencing.txt",
    "rdrp2_derepression": "data/gene_lists/rdrp2_derepression.txt",
